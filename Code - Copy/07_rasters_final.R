...
### for Maui county, mask bare areas that have very high probabilities ###

# load mask
sf_mask <- read_sf("H:/My Drive/Projects/PICASC Land-to-sea/Data/Processed/Fire/Maui high risk mask/mauiRiskMask.shp")

# mask raster using min value within mask
r <- raster_list_dry[[3]]
r2 <- mask(r, sf_mask, inverse = TRUE,
           updatevalue = cellStats(mask(r, sf_mask), stat = 'min'))
raster_list_dry[[3]] <- r2
rm(r, r2); gc()
